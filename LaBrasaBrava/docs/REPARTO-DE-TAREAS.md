...
3. **Cuatro personas tocando los mismos archivos es un problema de integración.** Cada uno es
   dueño de su propia carpeta dentro de `pages/`, y los archivos compartidos se tocan lo menos
   posible.
...
**Una rama por integrante**, y cada uno es dueño de su carpeta dentro de `src/app/pages/`:
